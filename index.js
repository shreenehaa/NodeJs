...
app.get("/movies", function (request, response) {
  ...
  if ("name" in querys) {
    //empty sing,null means also comes to if block
    var found_movie = movies.find(
      (movi) => movi.name.toLowerCase() == querys.name.toLowerCase()
    );
    response.send(found_movie);
  } else {
...
app.get("/movies/:id", function (request, response) {
  var id_movie = request.params.id;
